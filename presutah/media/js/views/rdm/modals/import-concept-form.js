        ...
        initialize: function(){
            ...
            this.$el.find('input.concept_import').select2({
                ...
                formatResult:function(result, container, query, escapeMarkup){
                    ...
                    var formatedresult = '<span class="concept_result">' + markup.join("")  + '</span> - <a href="' + result.Subject.value + '" target="_blank">' + result.Subject.value + '</a><div><i class="concept_result_schemaname">(Type: ' + result.Type.value + ')</i></div><i class="concept_result_schemaname">(Note: ' + result.ScopeNote.value + ')</i></div><div><i class="concept_result_schemaname">(Parent: ' + result.Parents.value + ')</i></div>';
